...
public class ImageFormHandlerServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    //makes name unique so that it won't overide other images
    ...
    out.println("</a>");
    out.println("<p>Here's the text about your picture:</p>");
    out.println(message);
  }
  ...
  private static String uploadToCloudStorage(String fileName, InputStream fileInputStream) {
    ...
    String bucketName = "clemus-sps-spring21.appspot.com";
    Storage storage =
